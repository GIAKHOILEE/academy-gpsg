...
import { NavigationParentController, NavigationParentControllerUser } from './navigation-parent/navigation-parent.controller'
...
@Module({
  ...
  controllers: [NavigationParentController, NavigationParentControllerUser, NavigationSubController, NavigationSubControllerUser],

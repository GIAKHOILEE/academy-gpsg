export const messages = {
  en: {
    ...
    CLASS_DOES_NOT_SUPPORT_VIDEO: 'Class does not support video',
    CLASS_DOES_NOT_SUPPORT_MEETING: 'Class does not support meeting',
    CLASS_DOES_NOT_SUPPORT_LEARN_TYPE: 'Class does not support learn type',
    ENROLLMENT_NOT_FOUND: 'Enrollment not found',
    ENROLLMENT_NOT_DEBT: 'Enrollment is not debt',
    ENROLLMENT_NOT_PAID: 'Enrollment has not been paid',
    ENROLLMENT_NO_ONLINE_CLASS: 'Enrollment does not have any online or video classes',
    ...
    JUST_ONE_ANSWER_PER_QUESTION: 'Just one answer per question',
    ...
    QUESTION_NOT_BELONG_TO_HOMEWORK: 'Question not belong to homework',
    TOTAL_POINTS_MISMATCH: 'Total points mismatch',
    MULTIPLE_CHOICE_MUST_HAVE_AT_LEAST_ONE_CORRECT_OPTION: 'Multiple choice must have at least one correct option',
    MULTIPLE_CHOICE_MUST_HAVE_AT_LEAST_TWO_OPTIONS: 'Multiple choice must have at least two options',
    QUESTION_REQUIRES_ANSWER_TEXT: 'Question requires answer text',
    QUESTION_REQUIRES_FILE: 'Question requires file',
    QUESTION_REQUIRES_SELECTED_OPTION_IDS: 'Question requires selected option ids',
    ...
    ACTIVE_HOMEWORK_EXISTS: 'Only one active homework per lesson',
    FINAL_HOMEWORK_EXISTS_IN_CLASS: 'Class already has final homework',
    HOMEWORK_TIME_EXPIRED: 'Homework time expired',
    INVALID_SCORE: 'Invalid score',
    SCORE_INVALID: 'Score must be between 0 and 10',
  ...
  vi: {
    ...
    CLASS_DOES_NOT_SUPPORT_VIDEO: 'Lớp học không hỗ trợ học qua video',
    CLASS_DOES_NOT_SUPPORT_MEETING: 'Lớp học không hỗ trợ học qua meeting',
    CLASS_DOES_NOT_SUPPORT_LEARN_TYPE: 'Lớp học không hỗ trợ hình thức học',
    ENROLLMENT_NOT_FOUND: 'Đơn đăng ký không tồn tại',
    ENROLLMENT_NOT_DEBT: 'Status là nợ học phí mới được cập nhật prepaid',
    ENROLLMENT_NOT_PAID: 'Đơn đăng ký chưa được thanh toán thành công',
    ENROLLMENT_NO_ONLINE_CLASS: 'Đơn đăng ký không có môn học theo hình thức trực tuyến hoặc qua video',
    ...
    SCORE_INVALID: 'Điểm phải nằm trong khoảng 0-10',
    ONLY_STUDENT_OR_TEACHER: 'Role không hợp lệ, chỉ cho phép STUDENT hoặc TEACHER',
    NO_EMAIL_FOUND: 'Không tìm thấy email người nhận',
    CLASS_ACTIVITIES_NOT_FOUND: 'Hoạt động lớp học không tồn tại',
    ...
    JUST_ONE_ANSWER_PER_QUESTION: 'Câu hỏi chỉ được trả lời một lần',
    ...
    HOMEWORK_ALREADY_SUBMITTED: 'Bài tập đã được nộp, không được nộp lại',
    ACTIVE_HOMEWORK_EXISTS: 'Chỉ được 1 bài tập được active',
    FINAL_HOMEWORK_EXISTS_IN_CLASS: 'Lớp học đã có bài tập cuối kì',
    HOMEWORK_TIME_EXPIRED: 'Thời gian làm bài đã hết',
    TOTAL_POINTS_MISMATCH: 'Tổng điểm các câu hỏi không khớp với điểm tối đa của bài tập',
    MULTIPLE_CHOICE_MUST_HAVE_AT_LEAST_ONE_CORRECT_OPTION: 'Câu hỏi multiple choice phải có ít nhất 1 đáp án đúng',
    MULTIPLE_CHOICE_MUST_HAVE_AT_LEAST_TWO_OPTIONS: 'Câu hỏi multiple choice phải có ít nhất 2 lựa chọn',
    ANSWERS_REQUIRED: 'Đáp án là bắt buộc',
    QUESTION_NOT_BELONG_TO_HOMEWORK: 'Câu hỏi không thuộc bài tập',
    QUESTION_REQUIRES_ANSWER_TEXT: 'Câu hỏi yêu cầu đáp án',
    QUESTION_REQUIRES_FILE: 'Câu hỏi yêu cầu file',
